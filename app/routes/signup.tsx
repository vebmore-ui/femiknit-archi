...
import { Heart, Mail, Lock, Eye, EyeOff, ArrowRight, User, ArrowLeft } from "lucide-react";
...
export default function SignUp() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (result.error) {
      ...
      setSuccess(true);
      setRedirecting(true);
      setTimeout(() => navigate("/signin?registered=1"), 8000);
    }
  };
    ...
    <div className="min-h-screen bg-white flex items-center justify-center px-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          >
            <h1 className="font-serif text-3xl font-bold text-rose-950">Create Account</h1>
            <p className="mt-2 text-gray-500">Join Femiknit for exclusive deals</p>
          </motion.div>
        </div>
        ...
        {success && (
          ...
          >
            Account created! Please wait while we sync your data...
          </motion.div>
        )}
        ...
        >
          ...
          <div className="flex items-start gap-2">
            <input type="checkbox" className="mt-1 rounded border-gray-300 text-rose-600 focus:ring-rose-500" required />
            <span className="text-sm text-gray-600">
              I agree to the{" "}
              <a href="#" className="text-rose-700 font-medium">Terms of Service</a>
              {" "}and{" "}
              <a href="#" className="text-rose-700 font-medium">Privacy Policy</a>
            </span>
          </div>
          ...
          >
            {redirecting ? "Redirecting..." : loading ? "Creating Account..." : "Create Account"} <ArrowRight size={18} />
          </button>
        </motion.form>
        ...
        <p className="mt-8 text-center text-sm text-gray-600">
          ...
          <Link to="/signin" className="font-semibold text-rose-700 hover:text-rose-800">
            Sign in
          </Link>
        </p>
      </motion.div>
        ...
        {redirecting && (
          ...
          >
            ...
            >
              ...
              <p className="font-serif text-xl font-bold text-rose-950">Redirecting to sign in...</p>
            </motion.div>
          </motion.div>
        )}
      </AnimatePresence>
